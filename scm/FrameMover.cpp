...
TimedActionType * PunctualFrameMover::registerTimedAction (float after_t, boost::function<void()> act, bool cancelable)
{
    TimedActionType * p = new TimedActionType (after_t + system_move_time_, act, cancelable);
